    ...
    >
      <div className="flex flex-col lg:flex-row">
        <div className="lg:w-1/2 pr-8">
          <h2 className="text-3xl font-serif mb-6 text-navy dark:text-cream">あなた好みの日本酒が見つかりました</h2>
          ...
          <div className="mb-8">
            <h4 className="text-xl font-medium mb-4 text-navy dark:text-cream">味わい、風味</h4>
          ...
          <div>
            <h4 className="text-xl font-medium mb-4 text-navy dark:text-cream">ペアリング</h4>
